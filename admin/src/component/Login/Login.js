      ...
      <div className="screen-login__user" data-aos="fade-right">
        <table className="screen-login__user__group">
          <tr>
            <td>
              <input
                className="screen-login__user__input"
                type="text"
                id="userName"
            ...
            <td>
              <img
                className="screen-login__user__icon"
                src={iconUser}
                alt="icon_user"
              />
            </td>
      ...
      <div className="screen-login__lock" data-aos="fade-left">
        <table className="screen-login__lock__group">
          <tr>
            <td>
              <input
                className="screen-login__lock__input"
                type="password"
                id="passWord"
            ...
            <td>
              <img
                className="screen-login__lock__icon"
                src={iconUnlock}
                alt="icon_password"
              />
            </td>
      ...
      <div className="screen-login__button">
        <table className="screen-login__button__group">
          <tr>
            <td>
              <button
                className="screen-login__button__login"
                data-aos="fade-right"
                onClick={onLogin}>
                Login
              </button>
